...
export const config: wdi5Config = {
    ...
    //     waitForUI5Timeout: 1500000 // [optional] {number}, default: 15000; maximum waiting time in milliseconds while checking for UI5 availability
    // },
    //
    // ====================
    ...
    //
    specs: ["./test/**/*.test.ts", "./test/e2e/journeys/**/*.test.ts"],
    // Patterns to exclude.
    exclude: [
